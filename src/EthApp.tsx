...
class EthApp extends React.Component<{}, State> {
  ...
  async acctInfo() {
    ...
    if (accts.length <= 1) {
      console.log(`${EthApp.accounts.length} hardcode accounts`)
      accts = EthApp.accounts
    }
  ...
  render() {
    return (
      <div className="EthApp">
        ...
        <button onClick={e => this.testSend(EthApp.accounts[1])} >Test Send</button>
